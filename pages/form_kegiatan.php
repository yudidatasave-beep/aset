...
<h4>Form Kegiatan Pemelihraan dan Perbaikan</h4>

<!-- ✅ FORM PENCARIAN -->
<form method="get" action="index.php">
    <input type="hidden" name="page" value="form_kegiatan">
    <div class="mb-3">
    ...
    if ($result->num_rows > 0) {
        ...
        while ($aset = $result->fetch_assoc()) {
            echo "<tr>
                ...
                <td>
                    <a href='pages/kegiatan_detail.php?id_aset={$aset['id_aset']}' class='btn btn-sm btn-success'>Pilih</a>
                </td>
            </tr>";
        }
